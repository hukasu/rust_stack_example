...
use crate::{model::{FinancialDataResponse, FinancialDataReport, FinancialDataQuery, Pagination, ResponseInfo}, error::{ServerError, ResponseError}};
...
) -> Result<Json<FinancialDataResponse>, ResponseError<ServerError>> {
